...
class SnarxPaperless extends Contract {
  ...
  async VerifiedUserCustomer(ctx, companyName, mailId, rol) {
    // verify Customer
  ...
  async RegisterProvider(ctx, emailId, companyName) {
    let provider = {
      emailId: emailId,
      companyName: companyName,
      type: "provider",
